...
class AnomalyCLIP_PromptLearner(nn.Module):
    def __init__(self, clip_model, design_details):
        ...
        self.text_encoder_n_ctx = design_details[
        ...
        #     with torch.no_grad():
        #         # 生成相应的text embedding
        #         embedding_pos = clip_model.token_embedding(prompt_pos).type(
        #             dtype
        #         )
        #         embedding_neg = clip_model.token_embedding(prompt_neg).type(
        #             dtype
        #         )
