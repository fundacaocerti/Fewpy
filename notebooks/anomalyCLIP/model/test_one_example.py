...
import numpy as np
import torch
from models.AnomalyCLIP import AnomalyCLIP_lib
from models.AnomalyCLIP.prompt_ensemble import AnomalyCLIP_PromptLearner
from models.AnomalyCLIP.utils import normalize
...
def test(args):
    ...
    with torch.no_grad():
        ...
        visualizer(
            image_path, anomaly_map.detach().cpu().numpy(), args.image_size
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_path",
        type=str,
        default="./dataset/CERTI/Mancha-AAJ-696/support/Image__2023-10-05__09-09-10.bmp",
        help="path to test dataset",
    )
    parser.add_argument(
        "--checkpoint_path",
        type=str,
        default="./models/AnomalyCLIP/checkpoints/9_12_4_multiscale/epoch_15.pth",
    ...
    parser.add_argument(
        "--image_size", type=int, default=518, help="image size"
    )
